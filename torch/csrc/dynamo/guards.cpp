...
#endif
#ifdef USE_MPS
  else if (device_type == c10::DeviceType::MPS) {
    return THPVariable_Wrap(at::detail::empty_strided_mps(
        sizes, strides, dtype, c10::DeviceType::MPS));
  }
#endif
  else {
    TORCH_CHECK(
...
static PyObject* _empty_strided_mps(PyObject* dummy, PyObject* args) {
  // at::empty_strided is surprising slow.  This is lower-overhead.
  return _empty_strided_device(dummy, args, c10::DeviceType::MPS);
}
...
static PyMethodDef _methods[] = {
    ...
    {"_empty_strided_mps", _empty_strided_mps, METH_VARARGS, nullptr},
