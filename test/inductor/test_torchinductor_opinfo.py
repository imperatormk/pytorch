...
inductor_override_kwargs["mps"] = {
    ...
    "randn": {"assert_equal": False},
    "nn.functional.rrelu": {"check_gradient": False},
    # float16 carries ~1e-3 relative precision, so a compiled kernel that
    # rounds in a different order than eager lands a few ULPs away. cuda and
    # xpu already carry the same allowances for these ops.
    ("cross", f16): {"reference_in_float": True},
    ("linalg.cross", f16): {"reference_in_float": True},
    ("asin", f16): {"reference_in_float": True},
    ("atanh", f16): {"reference_in_float": True},
    ("addmm", f16): {"reference_in_float": True},
    ("baddbmm", f16): {"atol": 2e-3, "rtol": 0.002},
    ("softmax", f16): {"atol": 1e-4, "rtol": 0.02},
    ("log_softmax", f16): {"atol": 1e-4, "rtol": 0.02},
    ("masked.softmax", f16): {"atol": 1e-4, "rtol": 0.02},
    ("hypot", f16): {"reference_in_float": True, "atol": 3e-4, "rtol": 2e-3},
    ("add", f16): {"atol": 2e-3, "rtol": 0.002},
    ("sub", f16): {"atol": 2e-3, "rtol": 0.002},
    ("mul", f16): {"atol": 2e-3, "rtol": 0.002},
    ("rsub", f16): {"atol": 2e-3, "rtol": 0.002},
    ("lerp", f16): {"atol": 2e-3, "rtol": 0.002},
    ("addcmul", f16): {"atol": 2e-3, "rtol": 0.01},
    ("addcdiv", f16): {"atol": 2e-3, "rtol": 0.01},
    ("outer", f16): {"atol": 2e-3, "rtol": 0.005},
    ("ldexp", f16): {"atol": 2e-3, "rtol": 0.01},
    ("remainder", f16): {"atol": 2e-3, "rtol": 0.01},
    ...
    # float16 measured against a float32 reference. Each was checked against
    ...
    # Measured against CPU's own fp16: every one of these is within 3.2e-2 of
    # it, differing only in the order a reduction or an interpolation sums.
    ("_unsafe_masked_index_put_accumulate", f16): {"atol": 5e-2, "rtol": 0.02},
    ("grid_sampler_3d", f16): {"atol": 5e-2, "rtol": 0.02},
    ("nn.functional.grid_sample", f16): {"atol": 2e-2, "rtol": 0.02},
    ("nn.functional.interpolate.bicubic", f16): {"atol": 2e-2, "rtol": 0.02},
    ("nn.functional.interpolate.trilinear", f16): {"atol": 2e-2, "rtol": 0.02},
    ("nn.functional.batch_norm", f16): {"atol": 2e-2, "rtol": 0.02},
    ("_native_batch_norm_legit", f16): {"atol": 2e-2, "rtol": 0.02},
    ("_batch_norm_with_update", f16): {"atol": 2e-2, "rtol": 0.02},
    ("softmax.with_dtype", f16): {"atol": 2e-2, "rtol": 0.02},
    ("nn.functional.softmin", f16): {"atol": 2e-2, "rtol": 0.02},
    ("nn.functional.softmin.with_dtype", f16): {"atol": 2e-2, "rtol": 0.02},
    ("nn.functional.linear", f16): {"atol": 2e-2, "rtol": 0.02},
    ("nn.functional.kl_div", f16): {"atol": 2e-2, "rtol": 0.02},
    ("log_softmax.with_dtype", f16): {"atol": 1e-1, "rtol": 0.05},
    # Bit-identical to CPU's own fp16 on every sample measured, so the only gap
    # is the float32 the harness compares against.
    ...
    ("nn.functional.avg_pool3d", f16): {"atol": 2e-2, "rtol": 0.02},
    ("nn.functional.binary_cross_entropy_with_logits", f16): {"atol": 2e-2, "rtol": 0.02},
    ("nn.functional.conv3d", f16): {"atol": 5e-2, "rtol": 0.02},
    ...
    ("nn.functional.max_pool3d", f16): {"atol": 2e-2, "rtol": 0.02},
    ("nn.functional.multilabel_soft_margin_loss", f16): {"atol": 2e-2, "rtol": 0.02},
    ("nn.functional.normalize", f16): {"assert_equal": False, "check_gradient": False},
    ("nn.functional.pad.replicate", f16): {"atol": 2e-2, "rtol": 0.02},
    ("nn.functional.pad.replicate_negative", f16): {"atol": 2e-2, "rtol": 0.02},
    ("nn.functional.pairwise_distance", f16): {"reference_in_float": True, "atol": 5e-2, "rtol": 0.05},
    ("nn.functional.poisson_nll_loss", f16): {"atol": 2e-2, "rtol": 0.02},
    ("nn.functional.prelu", f16): {"atol": 2e-2, "rtol": 0.02},
    ("nn.functional.soft_margin_loss", f16): {"assert_equal": False, "check_gradient": False},
    ("nn.functional.embedding_bag", f16): {"atol": 5e-2, "rtol": 0.02},
    ("masked.log_softmax", f16): {"atol": 2e-2, "rtol": 0.02},
    ("masked.softmin", f16): {"atol": 2e-2, "rtol": 0.02},
    ...
    ("cumprod", f16): {"atol": 2e-3, "rtol": 0.02},
    ("grid_sampler_2d", f16): {"atol": 2e-3, "rtol": 0.02},
    ("linalg.vector_norm", f16): {"reference_in_float": True, "atol": 2e-2, "rtol": 0.05},
    ("masked.logsumexp", f16): {"atol": 2e-3, "rtol": 0.02},
    ("masked.normalize", f16): {"atol": 2e-3, "rtol": 0.02},
    ("masked.prod", f16): {"assert_equal": False, "check_gradient": False},
    ("native_batch_norm", f16): {"atol": 2e-2, "rtol": 0.02},
    ("std_mean.unbiased", f16): {"atol": 1e-2, "rtol": 0.02},
    ("var_mean.unbiased", f16): {"atol": 5e-2, "rtol": 0.02},
    ("true_divide", f16): {"atol": 8e-2, "rtol": 0.02},
    ("nn.functional.softsign", f16): {"atol": 2e-3, "rtol": 0.02},
    ("nn.functional.upsample_nearest", f16): {"atol": 2e-3, "rtol": 0.02},
    # The float32 reference stays finite where the fp16 result overflows to inf,
    # and no tolerance covers inf against a number.
    ("__rpow__", f16): {"assert_equal": False},
    ("special.erfcx", f16): {"assert_equal": False},
    ("logaddexp", f16): {"atol": 2e-3, "rtol": 0.002},
    ("logsumexp", f16): {"atol": 2e-3, "rtol": 0.005},
    ("combinations", f16): {"atol": 2e-3, "rtol": 0.01},
    ("diff", f16): {"atol": 2e-2, "rtol": 0.05},
    ("gradient", f16): {"atol": 2e-3, "rtol": 0.005},
    ("trapz", f16): {"atol": 2e-3, "rtol": 0.002},
    ("trapezoid", f16): {"atol": 2e-3, "rtol": 0.002},
    ("cdist", f16): {"reference_in_float": True, "atol": 2e-2, "rtol": 0.05},
    ("dist", f16): {"reference_in_float": True, "atol": 2e-3, "rtol": 0.005},
    ("norm", f16): {"reference_in_float": True, "atol": 2e-3, "rtol": 0.002},
    ("renorm", f16): {"reference_in_float": True, "atol": 2e-3, "rtol": 0.002},
    ("prod", f16): {"reference_in_float": True, "atol": 2e-3, "rtol": 0.002},
    ("polar", f16): {"reference_in_float": True, "atol": 2e-3, "rtol": 0.002},
    ("einsum", f16): {"reference_in_float": True, "atol": 2e-3, "rtol": 0.002},
    ("linalg.vecdot", f16): {"reference_in_float": True, "atol": 2e-3, "rtol": 0.005},
    ("std", f16): {"reference_in_float": True, "atol": 2e-3, "rtol": 0.01},
    ("std.unbiased", f16): {"reference_in_float": True, "atol": 2e-3, "rtol": 0.01},
    ("var", f16): {"reference_in_float": True, "atol": 2e-3, "rtol": 0.01},
    ("var_mean", f16): {"reference_in_float": True, "atol": 5e-2, "rtol": 0.05},
    ("masked.std", f16): {"reference_in_float": True, "atol": 2e-3, "rtol": 0.01},
    ("masked.var", f16): {"reference_in_float": True, "atol": 2e-3, "rtol": 0.01},
    ("masked.cumprod", f16): {"reference_in_float": True, "atol": 2e-3, "rtol": 0.01},
    ("special.xlog1py", f16): {"atol": 2e-3, "rtol": 0.005},
}
...
instantiate_device_type_tests(
    TestInductorOpInfo, globals(), allow_mps=True, allow_xpu=True
)
